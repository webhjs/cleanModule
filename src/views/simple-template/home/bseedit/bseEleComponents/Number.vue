<template>
  <el-form label-width="80px" :model="formInline" :rules="rules" ref="attributeForm" :inline="true">
    ...
    <el-form-item label="最大值" class="form-item">
      <el-input class="input-item" v-model="formInline.max" placeholder="请输入最大值"></el-input>
    </el-form-item>
    <el-form-item label="最小值" class="form-item">
      <el-input class="input-item" v-model="formInline.min" placeholder="请输入最小值"></el-input>
    </el-form-item>
    <el-form-item label="数字类型" class="form-item">
      <el-select class="input-item" v-model="formInline.datatype" placeholder="选择数字类型">
        <el-option label="整数" value="inter"></el-option>
        <el-option label="小数" value="float"></el-option>
      </el-select>
    </el-form-item>
    <el-form-item label="小数位数" class="form-item">
      <el-input class="input-item" :disabled="formInline.datatype !== 'float'" v-model="formInline.floatNumer" placeholder="请输入保留几位小数"></el-input>
    </el-form-item>
  </el-form>
</template>

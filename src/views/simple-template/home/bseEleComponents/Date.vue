<template>
  <el-form label-width="80px" :model="formInline" :rules="rules" ref="attributeForm" :inline="true">
    ...
    <el-form-item label="默认值" class="form-item">
      <el-date-picker :value-format="formInline.dateformat" class="input-item" v-model="formInline.value" :type="formInline.datetype" placeholder="选择日期时间"></el-date-picker>
    </el-form-item>
    ...
    <el-form-item label="日期类型" class="form-item">
      <el-select class="input-item" v-model="formInline.datetype" placeholder="选择日期类型" @change="switchDatetype">
    ...
    <el-form-item label="最大日期" class="form-item">
      <el-date-picker :value-format="formInline.dateformat" class="input-item" v-model="formInline.max" :type="formInline.datetype" placeholder="选择日期时间"></el-date-picker>
    </el-form-item>
    <el-form-item label="最小日期" class="form-item">
      <el-date-picker :value-format="formInline.dateformat" class="input-item" v-model="formInline.min" :type="formInline.datetype" placeholder="选择日期时间"></el-date-picker>
    </el-form-item>
  </el-form>
</template>
